...
1,000 Genomes for any analysis of European ancestry data, as use of the 1,000 Genomes data has been found [here](https://www.preprints.org/manuscript/202507.0966) to lead to
...
- **Sample overlap file** (optional)
  ...
  - This can be obtained using the results from cross-trait LDSC (see [vignettes/sample_overlap.md](vignettes/sample_overlap.md)
    for a walk through on how to
    do this)
