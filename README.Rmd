...
They do! We can then run the multiple regression for all predictors. With this function, the last phenotype will be treated as the outcome by default (order can be changed with the 'phenos' argument)
