...
To read in the genotype data, LAVA uses functions from the snpStats package. As this package needs to be installed using BiocManager, you should do so before installing LAVA
...
-   **Reference genotype data** in plink format (.bim, .bed, .fam), used for the estimation of LD
    ...
    -   e.g. [1000 genomes](https://www.internationalgenome.org/data/) (pre-processed input files can be found [here](https://cncr.nl/research/lava/))
