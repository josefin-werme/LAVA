...
-   **Sample overlap file** (optional)
    ...
    -   This can be obtained using the results from cross-trait LDSC (see [vignettes/sample_overlap.md](vignettes/sample_overlap.md) for a walk through on how to do this)
