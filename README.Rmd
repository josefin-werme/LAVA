...
**For more elaborate example scripts intended for whole genome bivariate local rg analyses on a SLURM cluster (which also parallelise across loci), please see the cluster_setup/scripts folder here: <https://surfdrive.surf.nl/files/index.php/s/rtmNm8YZERGwl7f>**
